...
var g_terminalWs = new ActiveXObject('Rapise.WebServiceClient');
var g_termHwnd = null;
...
function Term_FindOrAttach(url, bAttach)
{
	...
	if( pid )
	{
		...
		wsh.Run('"%WORKDIR%x3270\\wc3270.exe" '+cmdLine+' '+url, 3, false);
		Global.DoSleep(1500);
...
function _TermSendCommand(/**string*/qry)
{
	...
	var responseJson = g_terminalWs.ExecuteRESTRequest(requestJson);
